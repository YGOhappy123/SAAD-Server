        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Milkteas_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Admins_ProcessingStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartItems_Milkteas_MilkteaId",
                        column: x => x.MilkteaId,
                        principalTable: "Milkteas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Milkteas_MilkteaId",
                        column: x => x.MilkteaId,
                        principalTable: "Milkteas",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Milkteas_CategoryId",
                table: "Milkteas",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_MilkteaId",
                table: "OrderItems",
                column: "MilkteaId");
